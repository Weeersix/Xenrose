        ...
        {
            {
                ...
                samum = new AccelerationTurret("samum") {{
                    ...
                    ammo(
                            XenItems.zinc, new BasicBulletType(5f, 35, "xenrose-arrow-bullet"){{
                                width = 11f;
                                height = 18f;
                                lifetime = 70f;
                                pierceCap = 3;
                                ...
                                shootEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            cone = 0;
                                            offset = 90;
                                            region = "xenrose-around-wave";
                                            sizeFrom = 10f;
                                            sizeTo = 7f;
                                            colorFrom = Color.valueOf("c3c0d9");
                                            colorTo = Color.valueOf("c3c0d900");
                                        }},
                                        new ParticleEffect(){{
                                            particles = 10;
                                            length = 10;
                                ...
                                chargeEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            sizeTo = 2.3f;
                                            cone = 50;
                                            colorFrom = Color.valueOf("8c8fa3ac");
                                            colorTo = Color.valueOf("8c8fa36d");
                                        }},
                                        new ParticleEffect(){{
                                            rotWithParent = true;
                                            followParent = true;
                                            ...
                                            sizeTo = 2f;
                                            cone = 50;
                                            colorFrom = Color.valueOf("adadad87");
                                            colorTo = Color.valueOf("adadad66");
                                        }}
                                );
                            ...
                            XenItems.gold, new BasicBulletType(4.5f, 50, "xenrose-arrow-bullet"){{
                                width = 11f;
                                height = 18f;
                                lifetime = 85f;
                                ammoMultiplier = 3;
                                ...
                                shootEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            sizeFrom = 10f;
                                            sizeTo = 7f;
                                            colorFrom = Color.valueOf("ffd9a5a8");
                                            colorTo = Color.valueOf("ffd9a565");
                                        }},
                                        new ParticleEffect(){{
                                            particles = 10;
                                            length = 10;
                                            ...
                                            sizeTo = 0;
                                            cone = 48;
                                            colorFrom = Color.valueOf("ffbb5c65");
                                            colorTo = Color.valueOf("ffbb5c65");
                                        }}
                                );
                                chargeEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            cone = 50;
                                            colorFrom = Color.valueOf("ffbb5c65");
                                            colorTo = Color.valueOf("ffd9a5a8");
                                        }},
                                        new ParticleEffect(){{
                                            rotWithParent = true;
                                            followParent = true;
                                            ...
                                            sizeTo = 2f;
                                            cone = 50;
                                            colorFrom = Color.valueOf("ffce8aa1");
                                            colorTo = Color.valueOf("ffce8a5b");
                                        }}
                                );
                                hitEffect = despawnEffect = new ExplosionEffect(){{
                                    lifetime = 34f;
                    ...
                    coolant = consume(new ConsumeLiquid(XenLiquids.liquidOrinil, 25f / 60f));
                }};
                ...
                shimmer = new ItemTurret("shimmer"){{
                    requirements(Category.turret, with(XenItems.damascus, 100, XenItems.zinc, 75, XenItems.gold, 40, XenItems.dantstalin, 35));

                    ammo(
                            XenItems.dantstalin, new ArtilleryBulletType(5.2f, 55, "xenrose-star-bullet"){{
                                width = height = 10f;
                                lifetime = 70f;
                                drag = 0.02f;
                                splashDamage = 135;
                                ...
                                velocityRnd = 0.6f;
                                buildingDamageMultiplier = 0.2f;
                                backColor = Color.valueOf("6c9395");
                                frontColor = trailColor = Color.valueOf("c4e6e0");
                                trailEffect = Fx.none;
                                ...
                                chargeEffect = new MultiEffect(
                                        new WaveEffect(){{
                                            ...
                                            strokeFrom = 0;
                                            strokeTo = 3;
                                            colorFrom = Color.valueOf("c4e6e0");
                                            colorTo = Color.valueOf("6c9395");
                                            sizeFrom = 28;
                                            sizeTo = 0;
                                            sides = 7;
                                        }},
                                ...
                                fragBullets = 5;
                                fragBullet = new BasicBulletType(3.6f, 30){{
                                    lifetime = 52;
                                    width = height = 9;
                                    frontColor = trailColor = Color.valueOf("c4e6e0");
                                    backColor = Color.valueOf("6c9395");
                    ...
                    drawer = new DrawTurret() {{
                        parts.add(new RegionPart("-blade") {{
                                      ...
                                      mirror = true;
                                      under = false;
                                      moves.add(new PartMove(PartProgress.recoil, 0, 0.58f, 0));

                                      children.add(new RegionPart("-hand"){{
                                ...
                                new RegionPart("-mid") {{
                                    ...
                                    mirror = false;
                                    under = false;
                                    moves.add(new PartMove(PartProgress.recoil, 0, -0.7f, 0f));
                                }});
                ...
                calmness = new AccelerationTurret("calmness"){{
                    ...
                    ammo(
                            XenItems.gold, new BasicBulletType(2f, 70, "xenrose-basic-bullet1"){{
                                ...
                                shootEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            cone = 0;
                                            offset = 90;
                                            region = "xenrose-shoot-explosion1";
                                            sizeFrom = 19f;
                                            sizeTo = 17f;
                                            colorFrom = Color.valueOf("ffb647");
                                            colorTo = Color.valueOf("ffb64700");
                                        }},
                                        new ParticleEffect(){{
                                            followParent = false;
                                            particles = 13;
                                            ...
                                            sizeFrom = 4f;
                                            sizeTo = 1.8f;
                                            colorFrom = Color.valueOf("ffce85");
                                            colorTo = Color.valueOf("ffce8500");
                                        }},
                                        new WaveEffect(){{
                                            lifetime = 18;
                                            strokeFrom = 1.8f;
                                            ...
                                            sizeFrom = 0;
                                            sizeTo = 22;
                                            colorFrom = Color.valueOf("ffeccf");
                                            colorTo = Color.valueOf("ffce8500");
                                        }}
                                );
                                ...
                                fragBullets = 14;
                                fragRandomSpread = 45;
                                fragBullet = new BasicBulletType(6f, 60){{
                                    keepVelocity = false;
                                    height = 16;
                                    width = 9;
                                    drag = 0;
                                    ...
                                    trailEffect = new MultiEffect(
                                            ...
                                            new WaveEffect(){{
                                                ...
                                                sizeFrom = 2.5f;
                                                sizeTo = 1.6f;
                                                colorFrom = Color.valueOf("ffeec2ab");
                                                colorTo = Color.valueOf("ffce5200");
                                            }});
                            ...
                            XenItems.protexide, new BasicBulletType(5.4f, 130, "xenrose-rhomb-bullet"){{
                                ...
                                frontColor = trailColor = Color.valueOf("ad93eb");
                                chargeEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            particles = 10;
                                            lifetime = 80;
                                            ...
                                            sizeFrom = 0f;
                                            sizeTo = 2.8f;
                                            colorFrom = Color.valueOf("69549ad9");
                                            colorTo = Color.valueOf("69549a87");
                                        }},
                                        new ParticleEffect(){{
                                            particles = 12;
                                            lifetime = 70;
                                            ...
                                            sizeFrom = 0;
                                            sizeTo = 3.5f;
                                            colorFrom = Color.valueOf("9b84d1b6");
                                            colorTo = Color.valueOf("9b84d173");
                                        }}
                                );
                                shootEffect = new MultiEffect(
                                        new ParticleEffect(){{
                                            ...
                                            sizeFrom = 19f;
                                            sizeTo = 17f;
                                            colorFrom = Color.valueOf("9b84d1");
                                            colorTo = Color.valueOf("9b84d173");
                                        }},
                                        new ParticleEffect(){{
                                            followParent = false;
                ...
                alignment = new AccelerationTurret("alignment"){{
                    requirements(Category.turret, with(XenItems.damascus, 120, XenItems.zinc, 85, XenItems.gold, 60, XenItems.protexide, 35));

                    ammo(
                            Items.sand, new ArtilleryBulletType(2, 135, "xenrose-basic-bullet1"){{
                                ...
                                buildingDamageMultiplier = 0.2f;
                                backColor = Color.valueOf("d3ae8d");
                                frontColor = trailColor = Color.valueOf("ffdfc2");
                                despawnShake = 6;
                                despawnSound = Sounds.titanExplosion;
                                trailInterval = 1.5f;
                                trailEffect = new ParticleEffect(){{
                                    colorFrom = Color.valueOf("ffdfc2");
                                ...
                                fragBullets = 3;
                                fragRandomSpread = 50;
                                fragBullet = new ArtilleryBulletType(2f, 45, "xenrose-basic-bullet1"){{
                                    splashDamage = 45;
                    ...
                    drawer = new DrawTurret() {{
                        parts.add(new RegionPart("-blade") {{
                            ...
                            mirror = true;
                            under = false;
                            moves.add(new PartMove(PartProgress.recoil, 0, -0.85f, 0));
                        }});
                    }};
